        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
            <Card className="p-0 box-shadow-md border-defaultborder shadow-md rounded-[10px] bg-white">
              ...
              <div className=" flex justify-center mt-4 bg-[#D9D9D9] border border-t-[#B3B3B3] p-8">
                <Button
                  className="text-white py-3 lg:w-[350px] md:w-[300px] sm:w-[300px] w-[250px] bg-black"
                  onClick={() => navigate("/")}
                >
                  Get Started
                </Button>
...
export default RedeemPointGuide;
