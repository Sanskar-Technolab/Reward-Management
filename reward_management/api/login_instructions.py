...
def add_new_instruction(new_image_url, image_description):
    ...
    # Ensure the inputs are lists
        ...
        frappe.log_error("API Add New Instruction Error", str(e))
        return {
            "success": False,
            "status": "failed",
            "message": str(e)
...
def add_update_instructions(image_url, new_image_url=None, new_image_description=None):
    try:
        ...
        frappe.log_error("API Add Update Instructions Error", str(e))
        return {
            "success": False,
            "status": "failed",
            "message": str(e)
...
def delete_selected_instruction(image_name,description):
    try:
        ...
        frappe.log_error("API Delete Selected Instruction Error", str(e))
        return {
            "success": False,
            "status": "failed",
            "message": str(e)
...
def delete_all_instructions():
    try:
        ...
        frappe.log_error("API Delete All Instructions Error", str(e))
        return {
            "success": False,
            "status": "failed",
            "message": str(e)
